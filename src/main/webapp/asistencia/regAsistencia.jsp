		...
		<div class="row">
			...
			<div class="form-group">
				<label class="text-secondary">Horario</label>
					...
					<br>
					<input class="form-control" type="text" value="<%=(horario != null && horario.getFechaInicio() != null && horario.getFechaFin() != null) 
					? "De " + horario.getFechaInicio().toString() + "hasta " + horario.getFechaFin().toString() : ""%>" readonly>
			</div>
		</div>

		<form action="AsistenciaEstudianteServlet" method="post" accept-charset="UTF-8">
			<input type="hidden" name="tipo" value="registrar">
			<input type="hidden" id="horarioID" name="horarioID" value="<%=request.getAttribute("horarioID")%>" readonly>
			<input type="hidden" id="estudianteID" name="estudianteID" value="<%=request.getAttribute("EstudianteID")%>" readonly>
			<br>
			...
			<div class="form-group">
				<label for="nombreCurso">Comentario</label> <input type="text" class="form-control" id="comentario" name="comentario" required>
			</div>
