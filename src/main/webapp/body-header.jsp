	...
	<nav class="header-nav ms-auto">
		<ul class="d-flex align-items-center">
			...
			<li class="nav-item dropdown pe-3"><a
				...
				data-bs-toggle="dropdown"> <img src="<%= request.getContextPath() %>/assets/img/profile-img.jpg"
				...
				<ul
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="Login.jsp"> <i class="bi bi-box-arrow-right"></i> <span>Cerrar Sesión</span>
					</a></li>
...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-navAs" data-bs-toggle="collapse" href="#">
                <i class="bi bi-layout-text-window-reverse"></i><span>Asistencias</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-navAs" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li><a href="<%= request.getContextPath() %>/AsistenciaServlet?tipo=list">
                ...
                %>
                <li><a href="<%= request.getContextPath() %>/AsistenciaServlet?tipo=registGet">
            ...
            %>
            <a class="nav-link collapsed" data-bs-target="#components-navHs" data-bs-toggle="collapse" href="#">
                <i class="bi bi-layout-text-window-reverse"></i><span>Horarios</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-navHs" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li><a href="<%= request.getContextPath() %>/HorarioServlet?tipo=list">
                    <i class="bi bi-circle"></i><span>Ver Horarios</span>
                </a></li>
                <li><a href="<%= request.getContextPath() %>/horario/regHorario.jsp">
            ...
            <ul id="components-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li><a href="<%= request.getContextPath() %>/EstudianteServlet?tipo=list">
                    <i class="bi bi-circle"></i><span>Estudiante</span>
                </a></li>
                <li><a href="<%= request.getContextPath() %>/ProfesorServlet?tipo=list">
                    <i class="bi bi-circle"></i><span>Profesor</span>
                </a></li>
                <li><a href="<%= request.getContextPath() %>/CursoServlet?tipo=listar">
                    <i class="bi bi-circle"></i><span>Curso</span>
                </a></li>
                <li><a href="<%= request.getContextPath() %>/SeccionServlet?tipo=listar">
            ...
            <a class="nav-link collapsed" data-bs-target="#components-navReporte" data-bs-toggle="collapse" href="#">
                <i class="bi bi-card-list"></i><span>Reportes</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-navReporte" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li><a href="<%= request.getContextPath() %>/CursoReporteServlet?action=reporte">
                    <i class="bi bi-circle"></i><span>Reporte Cursos</span>
                </a></li>
                <li><a href="<%= request.getContextPath() %>/AsistenciaServlet?tipo=viewreporte">
                    <i class="bi bi-circle"></i><span>Reporte Asistencia</span>
                </a></li>
                <li><a href="<%= request.getContextPath() %>/PadresTutoresServlet?tipo=viewreporte">
