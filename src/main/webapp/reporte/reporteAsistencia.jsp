	...
	<div class="container mt-4">
		<form id="horarioForm" action="AsistenciaEstudianteServlet"
			method="get">
			 <input type="hidden" name="tipo"
				value="reportelistAsistenciaxAlumno">
		...
		: ""%>>
						...
						<%=item.getHoraInicioFin()%> - 
							<%="Fecha de Inicio: " + item.getFechaInicio()%> -
								<%="Fecha de Fin: " + item.getFechaFin()%>
					</option>
					<%
					}
					} else {
...
%>
        ...
        <table class="table datatable">
            ...
            <tbody>
             ...
             <td><%= (asistencia.getFechaActualizacion() != null) ? asistencia.getFechaActualizacion() : "-" %></td>
...
<%
AsistenciaEstudiante asistencias = (listaAsistenciaEstudiante != null && !listaAsistenciaEstudiante.isEmpty()) 
    ? listaAsistenciaEstudiante.get(0) 
    : null;

if (asistencias != null) {
%>
    <input type="hidden" name="IDdeHorario" id="IDdeHorario" value="<%= asistencias.getHorarioID() %>">
    <input type="hidden" name="IDdeEstudiante" id="IDdeEstudiante" value="<%= asistencias.getEstudianteID() %>">
<a class="btn btn-danger" href="AsistenciaEstudianteServlet?tipo=generarReporte&IDdeHorario=<%= asistencias.getHorarioID() %>&IDdeEstudiante=<%= asistencias.getEstudianteID() %>">
    Generar Reporte
</a>
